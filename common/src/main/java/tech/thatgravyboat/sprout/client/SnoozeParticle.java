...
public class SnoozeParticle extends TextureSheetParticle {

    SnoozeParticle(ClientLevel world, double x, double y, double z, SpriteSet spriteProvider, double a, double b, double c) {
