...
public class ShootParticle extends SpriteBillboardParticle {

    ShootParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider, double a, double b, double c) {
    ...
    public float getSize(float tickDelta) {
        return (this.scale * 2) * (1f - ((float) this.age / this.maxAge));
    }
